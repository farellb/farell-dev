...
export function StoreSection() {
    return (
        <section className="relative w-full h-[80vh] bg-neutral-900 overflow-hidden">
            ...
            {/* Mərkəzi Nəhəng Mətn Overlay - Rains Style (Solid Grey/Silver) */}
            ...
            {/* Alt Məzmun - Sol Tərəf - Shopify Style */}
            <div className="absolute bottom-12 left-8 md:left-16 z-20 flex flex-col items-start gap-6">

                {/* Alt Yazı */}
                <p className="text-2xl md:text-3xl font-light text-white/80 max-w-md drop-shadow-md">
                    Müasir estetika və keyfiyyət.
                </p>

                {/* CTA Pill Button (Solid Grey) */}
                <Link
                    href="/stores"
