...
export default function VisionSection() {
    ...
    const centerOpacity = 0.5 + (progress * 0.5);

    const textSpacing = 20 - (progress * 20);
    ...
    return (
        <section ref={containerRef} className="relative w-full h-[250vh] bg-black">
            <div className="sticky top-0 w-full h-screen overflow-hidden flex flex-col md:flex-row pt-20 lg:pt-24">
                ...
                >
                    <Image src="/vision-model.png" alt="Form" fill className="object-cover" loading="lazy" quality={75} sizes="(max-width: 768px) 100vw, 33vw" />
